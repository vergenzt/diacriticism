var diacriticism = (function() {
  ...
  function getPresets() {
    return {
      ...
      '1-On': function(d) { return criticizeMarkN(d, 1, getFilteredMarker(function(d) { return d.position === 'on'; })); },
      '2-On': function(d) { return criticizeMarkN(d, 2, getFilteredMarker(function(d) { return d.position === 'on'; })); },
      '3-On': function(d) { return criticizeMarkN(d, 3, getFilteredMarker(function(d) { return d.position === 'on'; })); },
      '4-On': function(d) { return criticizeMarkN(d, 4, getFilteredMarker(function(d) { return d.position === 'on'; })); },
      '5-On': function(d) { return criticizeMarkN(d, 5, getFilteredMarker(function(d) { return d.position === 'on'; })); },
      'ZigZag': criticizeZigZag,
      'Hatted Tower': criticizeHattedTower,
  ...
  function getMarkMetadata() {
    return [
      ...
      {mark: '\u0334', position: 'on', tick: false, straight: false, angled: false, curved: true, multi: false},
      {mark: '\u0335', position: 'on', tick: false, straight: true, angled: false, curved: false, multi: false},
      {mark: '\u0336', position: 'on', tick: false, straight: true, angled: false, curved: false, multi: false},
